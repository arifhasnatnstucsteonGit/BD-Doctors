...
public class DoctorDetails extends Activity {
    TextView txtName,txtEmail,txtPhone,txtInfo,
            txtfield,txtchamber,txtlocation,txtlatitude,txtlongitude,txtPlace;
    ...
    private static final String url_product_detials = "http://bddoctors.honor.es//get_product_details.php";
...
//                            txtPlace=(TextView)findViewById(R.id.place);
                            ...
                            btn_location.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    Intent intent=new Intent(DoctorDetails.this,MapsActivity_Doctor.class);
                            ...
                            btn_call=(ImageButton)findViewById(R.id.btnCall);
                            btn_email=(ImageButton)findViewById(R.id.btnEmail);
