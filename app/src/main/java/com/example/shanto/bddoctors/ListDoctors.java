...
public class ListDoctors extends ListActivity {
    ...
    private static String url_all_doctors = "http://bddoctors.honor.es//get_all_products.php";
    ...
    class GetContacts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(ListDoctors.this);
...
//                }
        ...
        protected void onPostExecute(String result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ListDoctors.this, contactList,
                    R.layout.list_item_doctor, new String[]{TAG_DID,TAG_NAME
