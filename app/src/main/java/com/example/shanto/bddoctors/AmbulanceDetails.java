...
public class AmbulanceDetails extends Activity {
    TextView txtName,txtEmail,txtPhone,txtInfo,txtfield,txtchamber,txtlocation,txtlatitude,txtlongitude,txtPlace;
    private ProgressDialog pDialog;
    String pid;
    JSONParser jsonParser=new JSONParser();

    private static final String url_product_detials = "http://bddoctors.honor.es//ambulance_details.php";
    private static final String TAG_SUCCESS = "success";
    private static final String TAG_PRODUCT = "ambulance";
    ...
    private static final String TAG_CHAMBER = "chamberplace";
    ...
    class GetProductDetails extends AsyncTask<String,String,String>{
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(AmbulanceDetails.this);
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (success==1){
                          ...
                          //  txtfield=(TextView)findViewById(R.id.field);
                            txtchamber=(TextView)findViewById(R.id.chamber);
...
//                            txtPlace=(TextView)findViewById(R.id.place);
                            ...
                            txtchamber.setText(product.getString(TAG_CHAMBER));
                            ...
                            ImageButton btn_mail=(ImageButton)findViewById(R.id.btnEmail);
                            btn_location.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                    Intent intent=new Intent(AmbulanceDetails.this,MapsActivity_Doctor.class);
